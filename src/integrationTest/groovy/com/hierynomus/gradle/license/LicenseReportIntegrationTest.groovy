...
@Ignore("There is something incorrect in the test data. The test has been rewritten using Gradle TestKit - see: com.hierynomus.gradle.license.LicenseReportTestKitTest")
